...
Background music: Moon Castle
from PlayOnLoop.com
Licensed under Creative Commons by Attribution 4.0

Jump sound: Jump_C_05
...
void Initialize() {
    ...
    displayWindow = SDL_CreateWindow("Andrew Liang's Project 5- Platformer", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480, SDL_WINDOW_OPENGL);
    ...
    music = Mix_LoadMUS("moon_castle.wav");
