...
void Initialize() {
    ...
    GLuint spiderTextureID = LoadTexture("spider.png");
    GLuint wolfTextureID = LoadTexture("wolf.png");
    GLuint slimeTextureID = LoadTexture("slime.png");
    ...
    state.enemies[0].position = glm::vec3(-1.0, -3.25f, 0);
